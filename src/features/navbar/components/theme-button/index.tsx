...
const ThemeButton = () => {
  ...
  return (
    <button type='button' className='default-button theme-button' onClick={handleOnClick}>
      <svg className='light-theme-icon' fill='currentColor' viewBox='0 0 20 20'>
        <path d='M17.293 13.293A8 8 0 016.707 2.707a8.001 8.001 0 1010.586 10.586z'></path>
      </svg>

      <svg className='dark-theme-icon' fill='currentColor' viewBox='0 0 20 20'>
        <path
